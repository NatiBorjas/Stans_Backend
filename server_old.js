...
// CONEXION BD MONGO //
mongoose
	.connect(`mongodb+srv://naty:leia2824@ecommerce.nflhe41.mongodb.net/?retryWrites=true&w=majority`,
...
// REDIS // MONGODB SESSION
let MongoDBStore = require('connect-mongodb-session')(session);
// let sessionStore = new MongoDBStore({
// 	uri: `mongodb+srv://naty:leia2824@ecommerce.nflhe41.mongodb.net/?retryWrites=true&w=majority`,
// 	collection: 'session' });

// sessionStore.on("error", (error) => console.log(`Error en session ${error}`));
